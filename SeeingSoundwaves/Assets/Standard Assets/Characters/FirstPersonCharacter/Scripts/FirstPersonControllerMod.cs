    ...
    public class FirstPersonControllerMod : MonoBehaviour
    {
        ...
        private void RotateView()
        {
            if (!m_Block)
            {
                ...
                LookRotation = m_Camera.transform.localRotation;
                CharacterRotation = transform.localRotation;
            }
            else
            {
                //dont set it but calc it       
                Quaternion[] r = m_MouseLook.LookRotation(transform, m_Camera.transform, false);

                LookRotation = r[0];
                CharacterRotation = r[1];                
            }
        }
